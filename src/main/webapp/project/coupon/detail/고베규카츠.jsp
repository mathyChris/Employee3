	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<hr>
				<img class="img-responsive" src="image/고베규카츠.JPG" alt="">
				<hr>
				<p>
					야들야들한 스테이크와 건강을 책임지는 고소한 흑미의 만남! 상상그이상의 만남<br>
					[사용 가능일 12/16 ~03/16]홍대 고베규카츠 / 고베규카츠 스테이크 흑미덮밥
				<h4>10,000 -> 8,000</h4>
				</p>
				<a class="btn btn-primary"
					href="http://192.168.10.23:8080/Employee/project/myFavorite/Japanese_Food/SecondGate1.jsp">Store... <span class="glyphicon glyphicon-chevron-right"></span>
				</a>
