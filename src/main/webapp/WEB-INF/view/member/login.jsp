...
<!-- url 을 처리하는 부분   -->
<c:url var="LOGIN_URL" value="/member/login"/>
...
<!--                                         <button name="register" value="register">Register</button> -->
                        ...
                        <br>
                        <a href="/Employee/store/login.html" class="btn btn-sm btn-success"> to Entrepreneur (admin)</a>
                        <a href="/Employee/member/main.html#/append" class="btn btn-sm btn-success"> Append (member)</a>
