...
<div class="col-sm-8 col-sm-offset-2">
	<div class="panel panel-default">
		<div class="panel-heading">store 수정</div>
			<pre>{{store}}</pre>
		<div class="panel-body">
		<form name="storeForm" novalidate="novalidate" data-ng-submit="submit()">
			...
			<div class="form-group">
				...
				<div data-ng-show="storeForm.password.$dirty">
					...
					<div class="alert alert-warning" data-ng-show="storeForm.password.$error.maxlength || storeForm.password.$error.minlength">7자리만 입력가능합니다.</div>
				</div>	   
			</div>
