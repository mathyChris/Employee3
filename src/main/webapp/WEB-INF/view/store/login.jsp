...
<!--                                         <button name="register" value="register">Register</button> -->
                        ...
                        <br>
                        <a href="/Employee/member/login.html" class="btn btn-sm btn-success"> to Member (admin)</a> 
                        <a href="/Employee/store/main.html#/append" class="btn btn-sm btn-success"> Append (store)</a>
