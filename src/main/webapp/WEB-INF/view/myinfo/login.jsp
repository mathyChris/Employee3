...
<!-- url 을 처리하는 부분   -->
<c:url var="LOGIN_URL" value="/myinfo/login"/>
...
<!--                                         <button name="register" value="register">Register</button> -->
                                ...
                                <button type="submit" 
                                		...
                                		data-ng-disabled="loginForm.$invalid">Login (My Info)</button>
                                		
                            </fieldset>
                        </form>
                        <br>
                        <button><a href="/Employee/myStoreInfo/login.html" class="btn btn-sm btn-success"> to Entrepreneur (to 사업가)</a></button>
                        <button><a href="/Employee/member/main.html#/append" class="btn btn-sm btn-success"> Append (회원가입)</a> </button>
