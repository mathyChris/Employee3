    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="login-panel panel panel-default">
            ...
            <div class="panel-body">
				...
				<a href="login2.html" class="btn btn-primary">Append</a>	
				<a href="/Employee/myinfo/append" class="btn btn-primary">Append2</a>	
				<a href="../myinfo/main.html/append" class="btn btn-primary">Append3</a>
				<a href="#/append" class="btn btn-primary">Append</a>
				<link rel="import" href="/Employee/myinfo/main.html"> zzz
				 <div ng-include="/Employee/myinfo/main.html#/append"> zzz</div>	 
            </div> 
        </div>
    </div>
</div>
