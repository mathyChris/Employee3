...
<!-- URL Resolve -->
<c:url var="URL_GET_LIST"					value="/myinfo/"/>
<c:url var="URL_GET_ITEM_BASE" 				value="/myinfo/"/>		<%-- /member/{id} --%>

<c:url var="URL_GET_PAGE_BASE" 				value="/myinfo/page/"/>	<%-- /member/page/{pageNo} --%>

<c:url var="URL_POST_LIST_APPEND" 			value="/myinfo/"/>
<c:url var="URL_POST_ITEM_APPEND" 			value="/myinfo/"/>

<c:url var="URL_PUT_LIST_MODIFY" 			value="/myinfo/"/>
<c:url var="URL_PUT_ITEM_MODIFY_BASE" 		value="/myinfo/"/>		<%-- /member/{id} --%>

<c:url var="URL_DELETE_ITEM_DELETE_BASE" 	value="/myinfo/"/>		<%-- /member/{id} --%>
...
<c:url var="listController" value="/js/myinfo/listController.js"/>
<c:url var="detailController" value="/js/myinfo/detailController.js"/>
<c:url var="appendController" value="/js/myinfo/appendController.js"/>
<c:url var="modifyController" value="/js/myinfo/modifyController.js"/>
<c:url var="deleteController" value="/js/myinfo/deleteController.js"/>
